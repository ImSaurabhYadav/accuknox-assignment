...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', social_app.managers.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Friends',
            fields=[
                ...
                ('primary', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='primary_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FriendRequest',
